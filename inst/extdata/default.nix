# This file was generated by the {rix} R package v0.17.3 on 2026-01-15
# with following call:
# >rix(date = "2025-04-29",
#  > git_pkgs = list(list(package_name = "rix",
#  > repo_url = "https://github.com/ropensci/rix/",
#  > commit = "4a278c73a4cfd4a01dc2a50380a284bb0a782f18"),
 ...
 pkgs = import (fetchTarball "https://github.com/rstats-on-nix/nixpkgs/archive/2025-04-29.tar.gz") {};
    ...
    rix = (pkgs.rPackages.buildRPackage {
      ...
      src = builtins.fetchGit {
        ...
        rev = "4a278c73a4cfd4a01dc2a50380a284bb0a782f18";
      };
